...
|---:|---:|---|---|---:|---:|---:|---:|---:|
| 0 | 0 | lmcache_disk_uvm_kv_gpubpf_debt | true | 93.8413 | 1.8712 | 29.9386 | 8/0 | 0 |

## Per-arm values across attempted cells

| Arm | cells | warm TTFT medians (ms) | warm requests/s | warm out tok/s |
|---|---:|---|---|---|
| lmcache_disk_uvm_kv_gpubpf_debt | 1 | 93.8413 | 1.8712 | 29.9386 |
