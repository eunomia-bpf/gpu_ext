...
数据为准。RTX 5090 的 launchlate 性能数据来自完整 campaign
`../results-table1-warp-plt-575-06`（10 区块 / 70 单元全部有效）：gpubpf
0.221% 开销，NVBit 8.796%。版本化 endpoint 校准为 200/200 样本、759 ns 中位
