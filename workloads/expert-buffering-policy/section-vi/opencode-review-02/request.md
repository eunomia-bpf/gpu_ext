Return a visible final review in your answer content, beginning exactly COMPLETE FINAL REVIEW. A prior independent request produced only hidden reasoning and no visible text; that is not a completed review. Do not stop without writing the requested findings or explicitly NO BLOCKING FINDINGS. No tools are available or authorized. Review the complete supplied source in this message only.
