...
set $xg_driver = (void *)dlopen("/lib/x86_64-linux-gnu/libcuda.so.575.57.08", 6)
set $xg_launch = (void *)dlsym($xg_driver, "cuLaunchKernel")
printf "CONTROL driver handle %p launch entry %p\n", $xg_driver, $xg_launch
disable 1
break *$xg_launch
commands 2
silent
