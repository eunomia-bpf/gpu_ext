...
| --- | --- | --- |
| Table 1 observability | [Runtime dependency map](docs/artifact/table1-runtime.md), [completed component build](workloads/llama.cpp/observability_overhead/revision-rq4/raw/table1-component-build-20260909.jqAD9c/README.md) | `--build-only` built the three gpubpf tools and NVBit adapter without running measurement cells. Keep the seven-arm campaign, five selected GPU-array pairs, ten-pair extension and full-record supplements separate. A full fresh bpftime/llama.cpp runtime rebuild remains open. |
