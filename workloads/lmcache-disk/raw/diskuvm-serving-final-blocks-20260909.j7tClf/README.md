...
After source/result publication through 0f1253c0 and process exit, root
removed only the seven generated cache directories below. Each was
1208352768 bytes apparent size: 8458469376 bytes total (about 7.88 GiB).
They contain disposable KV payloads and can be regenerated by the recorded
workload, but are not recoverable from Git. Raw JSON, responses, logs,
reports, model weights and sources remain. Block-0 caches had already been
removed separately and were not touched again.

- `diskuvm-serving-20260909.9uBMtq/cells/block-01/position-0-native/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-01/position-1-bpf/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-01/position-2-stock/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-02/position-0-bpf/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-02/position-1-stock/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-02/position-2-native/cache`
- `diskuvm-serving-20260909.9uBMtq/cells/block-03/position-0-stock/cache`
