#!/usr/bin/env bash
set -euo pipefail
disk_raw=/home/yunwei37/workspace/gpu/gpu_ext/workloads/lmcache-disk/raw/disk-uvm-restore-20260908.cxYKb4
...
date -Is
kill -INT 3080911 3081084
disk_loaders_stopped=1
while kill -0 3080911 2>/dev/null || kill -0 3081084 2>/dev/null; do sleep 0.2; done
