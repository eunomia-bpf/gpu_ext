#!/usr/bin/env bash
set -euo pipefail
disk_raw=/home/yunwei37/workspace/gpu/gpu_ext/workloads/lmcache-disk/raw/disk-uvm-restore-20260908.cxYKb4/full-read-retry.4Nw61Y
...
date -Is
kill -INT 3142785 3142786
disk_loaders_stopped=1
while kill -0 3142785 2>/dev/null || kill -0 3142786 2>/dev/null; do sleep 0.2; done
