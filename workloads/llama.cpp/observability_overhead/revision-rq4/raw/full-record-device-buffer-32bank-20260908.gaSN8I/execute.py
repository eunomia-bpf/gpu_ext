#!/usr/bin/env python3
"""Real pp512 retry after the observed BTF size defect was repaired."""
import json
import os
import sys
...
row.update(source_commit="4dd36b63", layout="32-bank record-major GPU-local full records",
           scope="single prefill retry; no paired overhead claim")
