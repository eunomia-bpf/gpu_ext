...
The separately versioned endpoint control now **does** pass that gate: 200/200
samples have a 759 ns median conservative bracket versus the unchanged
<1,500 ns threshold. This admits the next clock-identity and 220-launch gates;
it is not yet a repaired `launchlate` result.
