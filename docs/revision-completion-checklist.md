...
Paper `6b34963` integrates this measured tradeoff, qualifies the old sub-1%
scheduling differences, and builds in 16 pages. The new visual panel remains
pending; the GPU matrix must not repeat. All historical data remain.
