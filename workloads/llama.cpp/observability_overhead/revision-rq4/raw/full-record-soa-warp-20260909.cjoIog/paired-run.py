#!/usr/bin/env python3
"""Five rotating warp-contiguous SoA/SoA/baseline comparisons for the warp-contiguous SoA
(full-record-device-buffer LAYOUT=soa-warp) layout.

Copy this file into the new campaign raw directory
(revision-rq4/raw/full-record-soa-warp-*), next to the copied warp-contiguous SoA
...
Arms:
  soa-warp    - 32-bank warp-contiguous SoA (warp-contiguous SoA) GPU-local full records
